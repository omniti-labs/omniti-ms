...
install_conffiles() {
    ...
    logcmd cp $SRCDIR/files/php.ini $DESTDIR/opt/php56/lib/php.ini
    logcmd cp $SRCDIR/files/php-fpm.conf $DESTDIR/opt/php56/etc/php-fpm.conf
    logcmd mkdir -p $DESTDIR/var/svc/manifest/application
    logcmd cp $SRCDIR/files/php56-fpm.xml \
        $DESTDIR/var/svc/manifest/application/php56-fpm.xml
}
