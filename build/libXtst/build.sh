...
VER=1.2.1
VERHUMAN=$VER
PKG=omniti/X11/libXtst
SUMMARY="libXtst for X11"
DESC=$SUMMARY
...
DEPENDS_IPS="developer/pkg-config omniti/library/freetype2 omniti/X11/inputproto omniti/X11/xextproto omniti/X11/recordproto omniti/X11/libXi omniti/X11/libXext omniti/X11/libX11"
