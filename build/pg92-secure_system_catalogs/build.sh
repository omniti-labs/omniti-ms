...
PROG=secure_system_catalogs
VER=0.0.0
VERHUMAN=$VER
: ${PGVER:=9221}
PKG=omniti/database/postgresql-${PGVER}/secure_system_catalogs
SUMMARY="$PROG - Non-superuser role visibility on catalog objects extention for PostgreSQL"
DESC="$SUMMARY"
