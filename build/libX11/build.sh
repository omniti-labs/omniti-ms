...
VER=1.5.0
VERHUMAN=$VER
PKG=omniti/X11/libX11
SUMMARY="libX11 for X11"
DESC=$SUMMARY
...
DEPENDS_IPS="developer/pkg-config omniti/library/freetype2 omniti/X11/xproto omniti/X11/xtrans omniti/X11/xextproto omniti/X11/xcbproto omniti/X11/kbproto omniti/X11/inputproto omniti/X11/libxcb"
