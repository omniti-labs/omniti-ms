...
VER=1.14.2
VERHUMAN=$VER
PKG=omniti/X11/recordproto
SUMMARY="recordproto for X11"
DESC=$SUMMARY
...
DEPENDS_IPS="developer/pkg-config omniti/library/freetype2 omniti/X11/xproto omniti/X11/xtrans omniti/X11/libXi" 
