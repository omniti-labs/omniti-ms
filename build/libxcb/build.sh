...
VER=1.8.1
VERHUMAN=$VER
PKG=omniti/X11/libxcb
SUMMARY="libxcb for X11"
DESC=$SUMMARY
...
DEPENDS_IPS="developer/pkg-config omniti/library/freetype2 omniti/X11/xcbproto omniti/X11/libpthread-stubs omniti/X11/libXau" 
