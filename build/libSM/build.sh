...
VER=1.2.1
VERHUMAN=$VER
PKG=omniti/X11/libSM
SUMMARY="libSM for X11"
DESC=$SUMMARY
...
DEPENDS_IPS="developer/pkg-config omniti/library/freetype2 omniti/X11/xproto omniti/X11/xtrans omniti/X11/libICE" 
